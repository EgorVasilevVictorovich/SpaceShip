...
public class Flight {
    ...
    public Flight(int screenX, int screenY, Resources resources) {
        ...
        flight1 = BitmapFactory.decodeResource(resources, R.drawable.flip2);
        flight2 = BitmapFactory.decodeResource(resources, R.drawable.flip6);
